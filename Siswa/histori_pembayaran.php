<?php
require "../Siswa/header_siswa.php";
require "../koneksi.php";
?>
    ...
    <form class="formnya-history" action="" method="POST" autocomplete="off">
        <h3>Cari Siswa</h3> <input type="text" name="nisn" value="<?php echo $_SESSION['nisn']; ?>"> <button class="btn btn-outline-dark" type="submit" name="cari">Cari</button>
    </form>
...
<?php }else{ ?> <td><font style="color: tomato; font-weight: bold;">BELUM LUNAS</font></td>
                <td style="display:none"><a href="../Petugas/transaksi.php?lunas&id=<?= $r_trx['id_pembayaran']; ?>">
                BAYAR LUNAS</a></td>
<?php } ?>
            </tr>
<?php $no++; }?>
...
<?php require_once("../Siswa/footer_siswa.php"); ?>
